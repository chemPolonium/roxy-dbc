...
//     //     if let Some(sw) = ui_state.message_windows.get(sig_idx) {
...
//     //         {
//     //             let file_part =
//     //                 format_file_label(parent.editable_data.base_file_path(), "(message)");
...
//     //             win.editable_data.base_file_path(),
//     //             "(dbc)",
//     //         ));
//     //     }
//     // }
...
//     // if let Some(window) = ui_state.get_focused_dbc_window() {
//     //     // 查找消息以获取其名称用于确认对话框
//     //     // Build a fallback name from editable data or default
//     //     let message_name = window
//     //         .editable_data
...
//     let used_ids: std::collections::HashSet<u32> = window
//         .editable_data
//         .messages()
//         .iter()
//         .map(|m| m.message_id())
...
//     //             transmitter: Some(m.transmitter().to_string()),
//     //             comment: Some(m.comment().to_string()),
//     //             signals: Vec::new(),
//     //         })
//     //         .collect::<Vec<_>>();
//     //     all_messages
...
//     // // new_message is already a `::MessageOverride`, use it directly
